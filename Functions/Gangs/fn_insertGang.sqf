...
if(count _queryResult != 0) exitWith {
	[[1,"Es gibt derzeit schon eine Gang mit diesen Namen, du musst dir einen anderen Namen aussuchen."],"life_fnc_broadcast",_ownerID,false] spawn life_fnc_MP;
...
_group setVariable["gang_maxMembers",5,true];
