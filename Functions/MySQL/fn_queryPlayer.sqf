...
*/
private["_uid","_side","_ownerID","_query","_return","_queryResult","_clientResult","_tickTime","_queryTime","_returnCount"];
_uid = [_this,0,"",[""]] call BIS_fnc_param;
_side = [_this,1,sideUnknown,[civilian]] call BIS_fnc_param;
_ownerID = [_this,2,ObjNull,[ObjNull]] call BIS_fnc_param;
_clientResult = [_this,3,[],[[]]] call BIS_fnc_param;
...
*/
_query = format["SELECT playerid, name, cash, bankacc, experience, arrested, licenses, gear, last_position, stats, skills, missions FROM players WHERE playerid='%1' AND side='%2'",_uid,_side];
...
/* 	Parse 	Player Licenses (Index 6), 
			...
			Player Skills (Index 10),
			Player Missions (Index 11);
*/
...
// Append Client Result to Query Result
