...
switch(_mode) do {
	case 0: {
		...
		_query = format["UPDATE players SET cash='%1' WHERE playerid='%2' AND side='%3'",_value,_uid,_side];
	};
	
	case 1: {
		_value = [_this,2,0,[0]] call BIS_fnc_param;
		_value = [_value] call DB_fnc_numberSafe;
		_query = format["UPDATE players SET bankacc='%1' WHERE playerid='%2' AND side='%3'",_value,_uid,_side];
	};
	
	case 2: {
		_value = [_this,2,[],[[]]] call BIS_fnc_param;
		_value = [_value] call DB_fnc_mresArray;
		_query = format["UPDATE players SET licenses='%1' WHERE playerid='%2' AND side='%3'",_value,_uid,_side];
	};
	
	case 3: {
		_value = [_this,2,[],[[]]] call BIS_fnc_param;
		_value = [_value] call DB_fnc_mresArray;
		_query = format["UPDATE players SET gear='%1' WHERE playerid='%2' AND side='%3'",_value,_uid,_side];
	};
	
	case 4: {
		_value = [_this,2,[],[[]]] call BIS_fnc_param;
		_value = [_value] call DB_fnc_mresArray;
		_query = format["UPDATE clients SET perms='%1' WHERE playerid='%2'",_value,_uid];
	};
	
	case 5: {
		_value = [_this,2,false,[true]] call BIS_fnc_param;
		_value = [_value] call DB_fnc_bool;
		_query = format["UPDATE players SET arrested='%1' WHERE playerid='%2' AND side='%3'",_value,_uid,_side];
	};
	...
	case 6: {
		...
		_query = format["UPDATE players SET cash='%1', bankacc='%2' WHERE playerid='%3' AND side='%4'",_value1,_value2,_uid,_side];
	};
};
